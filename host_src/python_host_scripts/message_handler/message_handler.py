...
def prepare_set_periodic_sampler_msg(sampling_period: int) -> main_pb2.HostToDeviceMessage:
    try:
...
def prepare_stop_periodic_sampler_msg() -> main_pb2.HostToDeviceMessage:
    try:
